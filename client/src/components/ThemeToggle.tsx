...
export default function ThemeToggle() {
  const { toggleDark, isDarkMode, isMobile } = useTheme()

  return (
    <div
      className={`dark-toggle h-12 w-full ${
        isMobile ? 'ml-4 w-[95%]' : 'max-w-[251px]'
      } bg-light-gray-bg dark:bg-v-dark-gray mx-auto rounded-md mb-[22px] flex gap-x-6 justify-center py-[14px]`}
    >
